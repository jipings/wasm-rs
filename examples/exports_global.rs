...
fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  // Create a Store. 
  // Note that we don't need to specify the engine/compiler if we want to use the default provided by Wasmer. 
  ...
  //
  // We will use an exported function for the `one` global and the Global API for `some`. 
